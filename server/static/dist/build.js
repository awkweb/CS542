...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_HomeView_vue__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_OrderView_vue__ = __webpack_require__(51);
...
/* harmony default export */ exports["a"] = new __WEBPACK_IMPORTED_MODULE_1_vue_router___default.a({
  routes: [{ path: '/', name: 'home', component: __WEBPACK_IMPORTED_MODULE_2__views_HomeView_vue___default.a }, { path: '/order/new', name: 'order-new', component: __WEBPACK_IMPORTED_MODULE_3__views_OrderView_vue___default.a }, { path: '/order/:id', name: 'order-update', component: __WEBPACK_IMPORTED_MODULE_3__views_OrderView_vue___default.a }]
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api__ = __webpack_require__(37);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_OrderDish_vue__ = __webpack_require__(48);
  ...
  methods: {
    ...
    addDish: function addDish() {
      ...
      if (this.customer.dishes.length > 0) {
        var dishNumbers = this.customer.dishes.map(function (c) {
          return c.number;
        });
...
/* harmony default export */ exports["default"] = {
  ...
  methods: {
    handleClick: function handleClick(orderId, orderStatus) {
      // if (orderStatus === 'Open')
  ...
  filters: {
    prettyDate: function prettyDate(dateString) {
      return __WEBPACK_IMPORTED_MODULE_1_moment___default()(dateString).fromNow();
    }
  }
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_OrderTable_vue__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_OrderCustomer_vue__ = __webpack_require__(47);
  ...
  return _h('div', {
    ...
    on: {
      "change": function($event) {
        dish.id = Array.prototype.filter.call($event.target.options, function(o) {
          return o.selected
        }).map(function(o) {
    ...
    return _h('tbody', [(order.status == orderFilter || orderFilter == 'All') ? _h('tr', {
      on: {
        "click": function($event) {
          handleClick(order.id, order.status)
        }
      }
    }, [_h('td', [_s(order.id)]), " ", _h('td', [_s(_f("prettyDate")(order.date))]), " ", _m(1, true), " ", _m(2, true), " ", _h('td', [_s(order.status)])]) : _e()])
  })])
}},staticRenderFns: [function (){with(this) {
